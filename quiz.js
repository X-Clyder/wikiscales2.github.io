...
var questions = [
  {
    question: "**1)** Чем больше прав и возможностей у каждого участника, тем общество справедливей и честней.<br>**2)**...",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "123! <span>Тестовый текст<sup class='help' title='Текст в подсказке'>?</sup> продолжение тестового текста.</span>",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "456! Тестовый текст<sup class='help' title='Текст в подсказке'>?</sup> продолжение тестового текста.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
